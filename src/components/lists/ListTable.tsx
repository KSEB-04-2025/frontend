      ...
      <div className="hidden h-[56.8px] items-center px-5 text-lg md:grid">
        <div className="grid grid-cols-[minmax(0,1fr)_200px_150px] items-center md:grid-cols-[minmax(0,1fr)_500px_200px]">
          <button
            type="button"
            onClick={() => onSort?.('id')}
            className="flex items-center gap-1 py-4 pl-10 text-left hover:opacity-90"
          >
            <span>Id</span>
          ...
          <button
            ...
            className="flex items-center gap-2 py-4 pl-1 text-left hover:opacity-90"
          >
            <span>Grade</span>
          </button>
          ...
          <button
            type="button"
            onClick={() => onSort?.('date')}
            className="flex items-center gap-1 py-4 pl-2 text-left hover:opacity-90"
          >
            <span>Date</span>
